...
if (NOT DEFINED RISCV AND DEFINED ENV{RISCV})
...
set(RISCV_GITHUB_GCC_COMPILER  ${RISCV}/bin/${COMPILER_PREFIX}elf-gcc)
set(RISCV_GITHUB_CLANG_COMPILER  ${RISCV}/bin/clang)
...
if (${COMPILER} MATCHES "clang")
     set( CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wno-unused-command-line-argument --target=riscv32 --gcc-toolchain=${RISCV} --sysroot=${RISCV}/${COMPILER_PREFIX}elf" )
endif()
